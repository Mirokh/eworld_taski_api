...
class CreateModuleController extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a new controller class into module';
    ...
    protected function qualifyClass($name)
    {
        ...
        return $this->getDefaultNamespace(trim($moduleNamespace, '\\')) . '\\' . $name;
    }
    ...
    {
        $name = Str::replaceFirst($this->moduleNamespace(), '', $name);
    ...
    protected function getDefaultNamespace($moduleNamespace)
    {
        ...
        return "Module\\$module\Controllers";
    }
    ...
    protected function parseModel($model)
    {
        ...
        if (!Str::startsWith($model, $moduleNamespace = $this->laravel->getNamespace())) {
            $model = $moduleNamespace . $model;
        }
